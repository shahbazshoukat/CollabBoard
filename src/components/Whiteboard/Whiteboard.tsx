import { useMutation, RoomProvider, useHistory, useStorage, useSelf, useOthersMapped, useCanUndo, useCanRedo } from '@liveblocks.config';
import { ClientSideSuspense } from '@liveblocks/react';
import { LiveList, LiveMap, LiveObject } from '@liveblocks/client';
import React, { useCallback, useEffect, useMemo, useState } from 'react';
import { Color, Layer, LayerType, CanvasState, CanvasMode, Camera, Side, XYWH, Point } from '@types';
import styles from './Whiteboard.module.css';
import { colorToCss, connectionIdToColor, findIntersectingLayersWithRectangle, penPointsToPathLayer, pointerEventToCanvasPoint, resizeBounds } from '@utils/utils';
...
import ToolsBar from '@components/ToolsBar/Toolbar';
